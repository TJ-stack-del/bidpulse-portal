...
================================================================================`;
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 relative">
      ...
      {selectedBid && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 print:static print:p-0">
          <div
            className="fixed inset-0 bg-black/80 backdrop-blur-sm cursor-pointer print:hidden"
            onClick={() => setSelectedBid(null)}
          />

          <div className="relative z-10 bg-slate-900 w-full max-w-3xl max-h-[92vh] border border-slate-700/80 rounded-2xl p-5 sm:p-7 flex flex-col justify-between overflow-hidden shadow-2xl space-y-5 print:border-none print:bg-white print:text-black print:max-h-none print:shadow-none print:p-0">
            ...
            {activeModalTab === "overview" && (
              <div className="space-y-4 overflow-y-auto pr-1 max-h-[50vh] print:hidden">
            ...
            {(activeModalTab === "scaffolding" || typeof window !== "undefined") && (
              <div className={`space-y-3 ${activeModalTab !== "scaffolding" ? "hidden print:block" : "block"}`}>
                ...
                <pre className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-[11px] sm:text-xs font-mono text-slate-300 whitespace-pre-wrap leading-relaxed max-h-[42vh] overflow-y-auto select-text print:bg-white print:text-black print:border-none print:max-h-none print:p-0 print:text-sm">
