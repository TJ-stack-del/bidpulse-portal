      ...
      <nav className="border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm font-medium">
            <Link href="/" className="hover:text-blue-600 text-slate-600 dark:text-slate-400">Home</Link>
            <Link href="/search" className="hover:text-blue-600 text-slate-600 dark:text-slate-400">Live Search</Link>
            <Link href="/portal" className="hover:text-blue-600 text-slate-600 dark:text-slate-400">Workspace</Link>
          </div>
        </div>
      </nav>
